<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tblEmployee' table. 
	...
	*/
	...
	function tblEmployee_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function tblEmployee_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function tblEmployee_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function tblEmployee_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function tblEmployee_batch_actions(&$args){
